...
add_bool_arg(parser, 'coefficients','Whether to keep track of linear components. (DEFAULT: FALSE',False)
add_bool_arg(parser, 'tm_var','Whether to vary timing model. (DEFAULT: True)',True)
add_bool_arg(parser, 'tm_linear','Whether to use only the linear timing model. (DEFAULT: FALSE)',False)

add_bool_arg(parser, 'nltm_plus_ltm','Whether to use non-linear plus linear timing model variations. (DEFAULT: FALSE)',False)
add_bool_arg(parser, 'fullnltm','Whether to include all fitparameters in the non-linear model, or just cool ones. (DEFAULT: FALSE)',False)

add_bool_arg(parser, 'exclude','Whether to exclude non-linear parameters from ' +\
  'linear timing model variations, or only include some parameters in linear timing model. (DEFAULT: TRUE)',True)

add_bool_arg(parser, 'writeHotChains','Whether to write out the parallel tempering chains. (DEFAULT: TRUE)',True)
add_bool_arg(parser, 'reallyHotChain','Whether to include a really hot chain in the parallel tempering runs. (DEFAULT: FALSE)',False)
