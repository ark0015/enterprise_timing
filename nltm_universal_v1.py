...
parser.add_argument(
    "--white_var", default=True, help="Vary the white noise? (DEFAULT: TRUE)"
)
parser.add_argument(
    "--red_var", default=True, help="Vary the white noise? (DEFAULT: TRUE)"
)
...
parser.add_argument(
    "--tm_var", default=True, help="Whether to vary timing model. (DEFAULT: True"
)
