...
add_bool_arg(
    parser,
    "sample_cos",
    "Whether to sample inclination in COSI or SINI. (DEFAULT: True)",
    True,
)
add_bool_arg(
    parser,
...
if args.datarelease == "all":
    ...
    parfile = top_dir + "/{}/narrowband/par/J0740+6620_NANOGrav_12yv3.gls.par".format(
        args.datarelease
    )
    timfile = top_dir + "/{}/narrowband/tim/J0740+6620_NANOGrav_12yv3.tim".format(
        args.datarelease
    )
